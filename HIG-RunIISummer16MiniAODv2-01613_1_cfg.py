...
# with command line options: step1 --fileout file:HIG-RunIISummer16MiniAODv2-01613.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step PAT --nThreads 4 --era Run2_2016 --python_filename HIG-RunIISummer16MiniAODv2-01613_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 5760
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:HIG-RunIISummer16DR80Premix-01616'+str(options.inputFiles[0])+'.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer16MiniAODv2-01613'+str(options.inputFiles[0])+'.root'),
