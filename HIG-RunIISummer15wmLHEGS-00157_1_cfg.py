...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-RunIISummer15wmLHEGS-00157-fragment.py nevts:5'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer15wmLHEGS-00157'+str(options.inputFiles[0])+'.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIISummer15wmLHEGS-00157_inLHE'+str(options.inputFiles[0])+'.root'),
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string(''),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    ...
    args = cms.vstring('/uscms_data/d3/rasharma/aashaq/ggh01_M125_Toa01a01_M20_Tomumubb_slc6_amd64_gcc481_CMSSW_7_1_30_tarball.tar.xz','5',str(Rnum))
)
