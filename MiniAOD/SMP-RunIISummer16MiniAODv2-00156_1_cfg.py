...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cmseos.fnal.gov//store/user/rasharma/CMSSW_FullSimulation_April2017/New_21May2017/GEN_SIM_RAW_Step2/WPlepWMhadJJ_EWK_LO_aQGC-FT-FS-FM_mjj100VJpT10_Pythia8CUEP8M1_13TeV_Madgraph_ext1/SMP-RunIISummer16DR80Premix-00158'+str(options.inputFiles[0])+'.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIISummer16MiniAODv2-00156'+str(options.inputFiles[0])+'.root'),
