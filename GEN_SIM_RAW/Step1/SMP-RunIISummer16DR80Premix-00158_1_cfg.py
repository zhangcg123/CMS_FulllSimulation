...
process.source = cms.Source("PoolSource",
    ...
    #fileNames = cms.untracked.vstring('file:SMP-RunIISummer15wmLHEGS-00090.root'),
    fileNames = cms.untracked.vstring('root://cmseos.fnal.gov//store/user/rasharma/CMSSW_FullSimulation_April2017/New_21May2017/WPlepWMhadJJ_EWK_LO_aQGC-FT-FS-FM_mjj100VJpT10_Pythia8CUEP8M1_13TeV_Madgraph_ext1/SMP-RunIISummer15wmLHEGS-00090'+str(options.inputFiles[0])+'.root'),
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIISummer16DR80Premix-00158_step1'+str(options.inputFiles[0])+'.root'),
...
process.mixData.input.fileNames = cms.untracked.vstring(['root://cmsxrootd.fnal.gov//store/user/rasharma/001EB167-3781-E611-BE3C-0CC47A4D75F4.root'])
