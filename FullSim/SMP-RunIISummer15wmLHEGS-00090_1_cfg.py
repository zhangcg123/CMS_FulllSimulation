...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/SMP-RunIISummer15wmLHEGS-00090-fragment.py nevts:10'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    ...
    args = cms.vstring('/storage/local/data1/condor/execute/dir_2345841/aQGC_WPlepWMhadJJ_EWK_LO_NPle1_mjj100pt10_tarball.tar.xz','10',str(Rnum))
)
